        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar2"
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav align-items-center justify-content-end align-items-center flex-grow-1 ">
              ...
              @if (Route::has('login'))
              <nav class="mx-20 flex flex-1 justify-end">
                  @auth
                      <!-- Show Dashboard for logged-in users -->
                      <li class="nav-item">
                          <a href="{{ url('/dashboard') }}" class="btn-medium btn btn-primary">
                          Profile
                          </a>
                      </li>
                  @else
                      ...
                      <li class="nav-item">
                          <a href="{{ route('login') }}" class="btn-medium btn btn-primary">
                              Login
                          </a>
                      </li>
                      @if (Route::has('register'))
                          <li class="nav-item">
                              <a href="{{ route('register') }}" class="btn-medium btn btn-primary">
                                  Register
                              </a>
                          </li>
                      @endif
